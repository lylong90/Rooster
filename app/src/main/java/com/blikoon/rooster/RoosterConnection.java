...
public class RoosterConnection implements ConnectionListener,ChatMessageListener {
    ...
    public RoosterConnection( Context context)
    {
        ...
        String jid = AppPreferences.getString(mApplicationContext, SharedPreferenceConstant.PREF_JID, null);
        mPassword = AppPreferences.getString(mApplicationContext, SharedPreferenceConstant.PREF_PASSWORD, null);
    ...
    public void processMessage(Chat chat, Message message) {
        ...
        if (message.getBody() == null) return;  // don't know why sometimes got null body
