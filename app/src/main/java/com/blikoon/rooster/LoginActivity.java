...
public class LoginActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mJidView.setText("lylong@xmpp.jp");
        populateAutoComplete();

        mPasswordView = (EditText) findViewById(R.id.password);
        mPasswordView.setText("Welcome2u");
...
//            startActivity(new Intent(this,ContactListActivity.class));
    ...
    private void saveCredentialsAndLogin()
    {
        ...
        AppPreferences.putString(this, SharedPreferenceConstant.PREF_JID, mJidView.getText().toString());
        AppPreferences.putString(this, SharedPreferenceConstant.PREF_PASSWORD, mPasswordView.getText().toString());
        AppPreferences.putBoolean(this, SharedPreferenceConstant.PREF_LOGGED_IN, true);
